...
## Caloosahatchee River Estuary (S79)
##
...
q.cre.dat.xtab$C43.QQmean=with(q.cre.dat.xtab,C43.basin.in/mean(subset(q.cre.dat.xtab,WY>2009)$C43.basin.in,na.rm=T))
...
plot(TP~C43.QQmean,cq.dat,log="xy")
plot(TN~C43.QQmean,cq.dat,log="xy")
...
vars=c("mean.TP","C43Basin","S77","S78","basin.q.ratio","S78Qfreq","LakeO","del.stg")
...
vars=c("mean.DIN","C43Basin","S79","S77","S78","basin.q.ratio","S78Qfreq","LakeO","del.stg")
...
mod.DIN=lm(log(mean.DIN) ~ S78 + basin.q.ratio + S78Qfreq + LakeO+del.stg ,cre.hydro.wq.mon[tr.index,])
summary(mod.DIN)
...
vars=c("mean.TN","C43Basin","S79","S77","S78","basin.q.ratio","S78Qfreq","LakeO","del.stg")
...
vars=c("mean.TON","C43Basin","S79","S77","S78","basin.q.ratio","S78Qfreq","LakeO","del.stg")
...
mod.TON=lm(log(mean.TON) ~ S78 + C43Basin+LakeO+del.stg ,cre.hydro.wq.mon[tr.index,])
summary(mod.TON)
